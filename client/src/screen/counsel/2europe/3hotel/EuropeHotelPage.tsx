...
import './EuropeHotelPage.scss';
import { AdminURL } from '../../../../MainURL';
import { useNavigate, useLocation } from 'react-router-dom';
import axios from 'axios';
import { useSetRecoilState, useRecoilValue } from 'recoil';
import { recoilSelectedHotelData, recoilProductName } from '../../../../RecoilStore';
...
interface EuropeHotelPageProps {
  stateProps?: any;
}

export default function EuropeHotelPage({ stateProps: propsStateProps }: EuropeHotelPageProps = {}) {

  const navigate = useNavigate();
  const location = useLocation();
  const locationStateProps = location.state;
  // props로 전달된 stateProps가 있으면 우선 사용, 없으면 location.state 사용
  const stateProps = propsStateProps || locationStateProps;
