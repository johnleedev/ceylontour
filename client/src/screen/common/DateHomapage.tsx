...
import './commonHomepage.scss'
import { useState } from "react";


interface DateHomepageProps {
  dateStart: any;
  dateEnd: any;
...
export const DateHomepage : React.FC<DateHomepageProps> = ({dateStart, dateEnd, setSelectStartDate, setSelectEndDate, marginLeft }) => {
  ...
  return (
    <div className='calendarbox_homepage'>
